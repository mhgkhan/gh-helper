...
export default function Home() {
  return (
   <>
    <main className="md:h-[80vh] h-[100vh] relative -z-0">
      <div className=" mainBg relative w-full h-full bg-black block"></div>
      <div className=" main-content absolute w-full h-full top-0 left-0 bg-transparent z-10 ">
        <div className="container mx-auto px-2 w-full h-full flex-col gap-6 flex items-center justify-center">
          ...
          <button className="z-50 md:mt-9 mt-2 mx-auto px-4 py-3 font-bold text-white cursor-pointer bg-purple-800 rounded-lg hover:shadow-md hover:shadow-cyan-500 hover:outline-2 hover:outline-cyan-400">Explorer</button>
        </div>
      </div>
    </main>
